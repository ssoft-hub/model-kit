#pragma once
#ifndef UTILITY_IS_FUNCTION_EXISTS_H
#define UTILITY_IS_FUNCTION_EXISTS_H

#include <type_traits>

#define IS_FUNCTION_EXISTS_TRAIT( function, shortname ) \
    ...
    template < typename ... _Arguments > \
    static constexpr bool is_ ## shortname ## _function_exists = Is_ ## shortname ## _FunctionExists< void, _Arguments ... >::value; \
